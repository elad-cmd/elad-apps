# Push mivdak-tanach code to GitHub repo elad-cmd/Mivdak_Tanach
# Run by double-clicking push-mivdak.bat
$ErrorActionPreference = "Stop"
Set-Location $PSScriptRoot
$RepoUrl = "https://github.com/elad-cmd/Mivdak_Tanach.git"

Write-Host "=== Push mivdak-tanach to GitHub ===" -ForegroundColor Cyan
...
git add -A | Out-Host
git commit -m "Initial commit - mivdak-tanach (368 questions)" 2>&1 | Out-Host
